    ...
    return (
        <>
            <div className='flex item-center justify-center md:justify-start md:px-16 border-b border-b-slate-200 bg-gradient-to-t  from-[#2C2C2C] via-[#1C1C1C] to-[#0D0D0D] drop-shadow-2xl'>
                <ul className='flex justify-center items-center py-4 gap-14 lg:gap-32 lg:px-32 md:max-w-6xl text-white font-bold overflow-x-auto overflow-y-hidden md:overflow-x-hidden'>
